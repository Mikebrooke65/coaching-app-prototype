...
INSERT INTO sessions (
  ...
  ARRAY['Eyes up', 'On toes', 'Acceleration with turns/fakes'],
  ...
  '20x20 metre grid marked with cones at corners and midpoints. 8-12 players each with a ball (orange bibs) spread throughout the area. Arrows show random dribbling patterns with sharp turns. Players performing ball mastery skills in space. No defenders in this session.'
);
...
INSERT INTO sessions (
  ...
  ARRAY['Introduce shielding — body between ball and defender', 'Same principles as next drill: protect the ball, scan, react quickly'],
  ...
  '20x20 metre grid. Most players (orange bibs) dribbling with a ball. 2-3 sharks (blue bibs) without balls chasing and trying to kick balls out. Arrows show sharks closing down dribblers. Highlighted player demonstrating shielding position: body between ball and approaching shark.'
);
...
INSERT INTO sessions (
  ...
  ARRAY['Shield by getting your body between the ball and defender', 'Open body — see both ball and player', 'Adjust and switch ball to other foot when defender comes ball-side'],
...
INSERT INTO sessions (
  ...
  ARRAY['Movement — get forward to support the ball carrier', 'Support angles — give the shielder passing options', 'Decision making — when to shield, when to pass, when to dribble'],
  ...
  '40x30 metre pitch with goals at each end. Halfway line marked with cones. Two teams (orange vs blue bibs), 4-6 per side. Dotted line shows halfway mark. Arrows show team pushing forward together. Highlighted player near halfway line shielding ball while waiting for teammates to advance. Ball with orange team player.'
);
