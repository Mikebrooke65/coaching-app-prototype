  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
        <div className="grid grid-cols-3 sm:grid-cols-6 max-w-lg mx-auto gap-1 px-2 py-1">
          ...
          {hasFullVersion && (
            <>
              ...
              >
                ...
                <span className="text-[9px] font-normal leading-tight mt-0.5">Home</span>
              </NavLink>
              ...
              >
                ...
                <span className="text-[9px] font-normal leading-tight mt-0.5">Coaching</span>
              </NavLink>
              ...
              >
                ...
                <span className="text-[9px] font-normal leading-tight mt-0.5">Games</span>
              </NavLink>
              ...
              >
                ...
                <span className="text-[9px] font-normal leading-tight mt-0.5">Resources</span>
              </NavLink>
              ...
              >
                ...
                <span className="text-[9px] font-normal leading-tight mt-0.5">Schedule</span>
              </NavLink>
              ...
              >
                ...
                <span className="text-[9px] font-normal leading-tight mt-0.5">Messages</span>
              </NavLink>
            </>
          )}
